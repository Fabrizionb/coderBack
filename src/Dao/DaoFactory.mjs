  ...
  static async getDao(type) { 
    switch (config.PERSISTENCE) {
      case "mongo":
        ...
        switch (type) {
          case 'cart':
            const {default: CartService} = await import('./mongo/cart.service.mjs');

            return new CartService();
          case 'user':
            const {default: UserService} = await import('./mongo/user.service.mjs');

            return new UserService();
          case 'product':
            const {default: ProductService} = await import('./mongo/product.service.mjs');

            return new ProductService();
          case 'ticket':
            const {default: TicketService} = await import('./mongo/ticket.service.mjs');
      ...
      case "memory":
        switch (type) {
          case 'cart':
            const {default: CartServiceFS} = await import('./memory/cart.service.mjs');
            return new CartServiceFS();
          case 'user':
            const {default: UserServiceFS} = await import('./memory/user.service.mjs');
            return new UserServiceFS();
          case 'product':
            const {default: ProductServiceFS} = await import('./memory/product.service.mjs');
