...
route.get("/forgot-password",controller.viewForgot)
...
authorization( 'admin'),
  passportCall("current"),
  controller.viewRealTime)
// Ruta para ver el chat en tiempo real
route.get("/chat",
  authorization(['user', 'admin']),
  passportCall("current"),controller.viewChat)
// Ruta para ver el perfil
route.get("/profile",
  authorization(['user', 'admin']),
  passportCall("current"),controller.viewProfile)
